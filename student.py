...
#image1
                img=Image.open(r"C:\Users\a\Desktop\FACE_RECOGNITION\College_images\imgd1.jpg")
...
#image2
                img1=Image.open(r"C:\Users\a\Desktop\FACE_RECOGNITION\College_images\imgd2.jpg")
...
#image3
                img2=Image.open(r"C:\Users\a\Desktop\FACE_RECOGNITION\College_images\imgd3.jpg")
 ...
 #background Imagre
                img3=Image.open(r"C:\Users\a\Desktop\FACE_RECOGNITION\College_images\img10.jpg")
                ...
                main_frame.place(x=5,y=50,width=1345,height=600)

        #left lable frame
                left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
                left_frame.place(x=10,y=10,width=660,height=580)

                img_left=Image.open(r"C:\Users\a\Desktop\FACE_RECOGNITION\College_images\imgd4.jpg")
                img_left=img_left.resize((650,90),Image.ANTIALIAS)
        ...
        #current course
                ...
                current_course_frame.place(x=5,y=100,width=660,height=110)
        #Department
                ...
                dep_combo["values"]=("Select Department","COMPUTER SCIENCE","IT","CIVIL","MECH","AUTO","EEE","ECE")
                dep_combo.current(0)
        ...
        #Course
                ...
                course_combo["values"]=("Select Course","ANT","CN","TOC","OOAD","MPMC","GIS","NW LAB","MPMC LAB","OOAD LAB")
        ...
        #Semester
                ...
                sem_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",11,"bold"),state="read only",width=20)
        ...
        #class student information
                ...
                class_student_frame.place(x=5,y=200,width=660,height=290)
        ...
        #Address
                address_label=Label(class_student_frame,text="Addresss:",font=("times new roman",12,"bold"),bg="white")
        ...
        #buttons frame
                ...
                btn_frame.place(x=0,y=203,width=650,height=25)

                save_btn=Button(btn_frame,text="save",command=self.add_data,width=22,font=("times new roman",8,"bold"),bg="blue",fg="white")
                save_btn.grid(row=0,column=0)

                update_btn=Button(btn_frame,text="update",command=self.update_data,width=22,font=("times new roman",8,"bold"),bg="blue",fg="white")
                update_btn.grid(row=0,column=1)

                delete_btn=Button(btn_frame,text="delete",command=self.delete_data,width=22,font=("times new roman",8,"bold"),bg="blue",fg="white")
                delete_btn.grid(row=0,column=2)

                reset_btn=Button(btn_frame,text="reset",command=self.reset_data,width=22,font=("times new roman",8,"bold"),bg="blue",fg="white")
                reset_btn.grid(row=0,column=3)

                btn_frame1=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
                btn_frame1.place(x=0,y=228,width=650,height=25)
                take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take sample photo",width=45,font=("times new roman",8,"bold"),bg="blue",fg="white")
                take_photo_btn.grid(row=0,column=0)

                update_photo_btn=Button(btn_frame1,text="update photo sample",width=45,font=("times new roman",8,"bold"),bg="blue",fg="white")
 ...
 #right lable frame
                ...
                img_right=Image.open(r"C:\Users\a\Desktop\FACE_RECOGNITION\College_images\imgd6.jpg")
                img_right=img_right.resize((650,90),Image.ANTIALIAS)
        ...
        #=========Search System=========
                ...
                search_frame.place(x=5,y=100,width=660,height=60)
                ...
                search_btn=Button(search_frame,text="Search",width=15,font=("times new roman",8,"bold"),bg="blue",fg="white")
                search_btn.grid(row=0,column=3,padx=4)

                showAll_btn=Button(search_frame,text="ShowAll",width=15,font=("times new roman",8,"bold"),bg="blue",fg="white")
                showAll_btn.grid(row=0,column=4,padx=4)

                #=====table frame=========
                table_frame=Frame(right_frame,bd=2,bg="white",relief=RIDGE)
                table_frame.place(x=5,y=180,width=660,height=290)
        ...
        def add_data(self):
                if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
                        ...
                        try:
                                ...
                                messagebox.showerror("Erroe",f"due to :{str(es)}",parent=self.root)
        ...
        def delete_data(self):
                if self.var_std_id.get()=="":
                        ...
                        try:
                                ...
                                self.fetch_data
                                conn.close()
                                messagebox.showinfo("Delete","successfully deleted student detail")
