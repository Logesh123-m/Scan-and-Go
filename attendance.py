...
#left label  frame
                ...
                left_inside_frame.place(x=0,y=130,width=650,height=300)
    ...
    #label Entry
                ...
                attendanceId_entry.grid(row=0,column=1,padx=10,pady=5,sticky=W)
                 ...
                 #student name
                studentName_label=Label(left_inside_frame,text="StudentName:",font=("times new roman",12,"bold"),bg="white")
                ...
                #Attendance status 
                att_label=Label(left_inside_frame,text="Attendance Status",font=("times new roman",12,"bold"),bg="white")
                att_label.grid(row=4,column=0,padx=10,sticky=W)

                att_combo=ttk.Combobox(left_inside_frame,textvariable=self.var_atten_attendance,font=("times new roman",11,"bold"),state="read only",width=20)
                att_combo["values"]=("Status","present","Absent")
                att_combo.current(0)
                att_combo.grid(row=4,column=1,padx=2,pady=10,sticky=W)

                #buttons frame
                btn_frame=Frame(left_inside_frame,bd=2,relief=RIDGE,bg="white")
                btn_frame.place(x=0,y=203,width=650,height=25)

                save_btn=Button(btn_frame,text="Import csv",command=self.importCsv,width=22,font=("times new roman",8,"bold"),bg="blue",fg="white")
                save_btn.grid(row=0,column=0)

                update_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,width=22,font=("times new roman",8,"bold"),bg="blue",fg="white")
                update_btn.grid(row=0,column=1)

                delete_btn=Button(btn_frame,text="Update",width=22,font=("times new roman",8,"bold"),bg="blue",fg="white")
                delete_btn.grid(row=0,column=2)

                reset_btn=Button(btn_frame,text="reset",width=22,command=self.reset_data,font=("times new roman",8,"bold"),bg="blue",fg="white")
...
#right lable frame
        ...
        def importCsv(self):
                global mydata
                mydata.clear()
                fln=filedialog.askopenfilename(initialdir=os.getcwd(),title="Open CSV",filetypes=(("CSV File","*csv"),("All File","*.*")),parent=self.root)                              #fln means file name
